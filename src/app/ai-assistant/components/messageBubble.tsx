...
export const AssistantMessage = ({ content,initialContent }: { content: string,initialContent?:string }) => (
  <div className={`flex gap-4 relative ${initialContent!=="Lassistant"?"ml-10":"ml-0"}`}>
